        ...
        {{
            ...
            "scenes": [
                {{
                    ...
                    "motion_prompt": "Description of how the scene should move and animate: camera movement, character actions, object motion, transitions. Be specific about motion direction, speed, and dynamics.",
